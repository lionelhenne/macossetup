...
apps='1password 1password-cli adobe-creative-cloud affinity-designer affinity-photo affinity-publisher appcleaner betterdisplay daisydisk discord firefox ghostty gnu-tar google-chrome handbrake iina localsend microsoft-auto-update microsoft-edge microsoft-excel microsoft-powerpoint microsoft-word mimestream openemu postman rsync setapp spotify suspicious-package todoist-app transmission transmit virtualbuddy visual-studio-code vivaldi'
