...
formulae='atuin bat composer duf eza fd fnm gnu-tar micro mkcert nss postgresql rsync starship stow tlrc tree wget zsh-autosuggestions zsh-syntax-highlighting'
